...
object Utilidades {
    ...
    const val CAMPO_LIBRAS_EXTRA = "libras_cosecha"
    const val CAMPO_PRECIO_EXTRA = "precio_cosecha"
    const val CAMPO_LIBRAS_PRIMERA = "libras_cosecha"
    const val CAMPO_PRECIO_PRIMERA = "precio_cosecha"
    const val CAMPO_LIBRAS_SEGUNDA = "libras_cosecha"
    const val CAMPO_PRECIO_SEGUNDA = "precio_cosecha"
    const val CAMPO_LIBRAS_TERCERA = "libras_cosecha"
    const val CAMPO_PRECIO_TERCERA = "precio_cosecha"
    const val CAMPO_LIBRAS_CUARTA = "libras_cosecha"
    const val CAMPO_PRECIO_CUARTA = "precio_cosecha"
    const val CAMPO_LIBRAS_QUINTA = "libras_cosecha"
    const val CAMPO_PRECIO_QUINTA = "precio_cosecha"
    const val CAMPO_LIBRAS_MADURA = "libras_cosecha"
    const val CAMPO_PRECIO_MADURA = "precio_cosecha"
