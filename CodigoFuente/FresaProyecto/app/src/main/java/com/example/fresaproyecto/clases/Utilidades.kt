...
object Utilidades {
    ...
    const val CAMPO_LIBRAS_COSECHA = "libras_cosecha"
    ...
    const val CREAR_TABLA_INGRESOS =
        ...
        /*"CREATE TABLE "+ TABLA_INGRESO_PERSONAL+"("+
                CAMPO_ID_INGRESO+" integer PRIMARY KEY, "+
                CAMPO_FECHA_INGRESO+" text, "+
                CAMPO_CONCEPTO_INGRESO+" text, "+
                CAMPO_PRECIO_INGRESO+" integer, "+
                CAMPO_PERSONA_INGRESO+" REFERENCES "+
                TABLA_PERSONA+"("+ CAMPO_ID_PERSONA+") ON DELETE NO ACTION ON UPDATE CASCADE"+
                ");"*/
        //"CREATE TABLE " + TABLA_INGRESO_PERSONAL + " (" + CAMPO_ID_INGRESO + " INTEGER, " + CAMPO_FECHA_INGRESO + " TEXT," + CAMPO_CONCEPTO_INGRESO +" TEXT," + CAMPO_PRECIO_INGRESO + " INTEGER )"
    ...
    const val CREAR_TABLA_COSECHA =
        ...
        "CREATE TABLE " + TABLA_COSECHA + " (" + CAMPO_ID_COSECHA + " INTEGER PRIMARY KEY, " + CAMPO_DIA_COSECHA + " INTEGER, " + CAMPO_MES_COSECHA + " INTEGER, " + CAMPO_AÑO_COSECHA + " INTEGER, "+ CAMPO_LIBRAS_COSECHA + " INTEGER, " + CAMPO_PRECIO_COSECHA + " INTEGER, " + CAMPO_OBSERVACION_COSECHA + " TEXT, " + CAMPO_CULTIVO_COSECHA+ " INTEGER REFERENCES " + TABLA_CULTIVO + "("+ CAMPO_ID_CULTIVO+") ON DELETE NO ACTION ON UPDATE CASCADE);"
