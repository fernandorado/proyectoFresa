 ...
 * Use the [MenuCultivoGastosFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MenuCultivoGastosFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        vista = inflater.inflate(R.layout.fragment_menu_cultivo_gastos, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment MenuCultivoGastosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MenuCultivoGastosFragment().apply {
